...
class TestOrmRepositories(unittest.TestCase):
    ...
    def test_create_task(self):
        ...
        task = OrmTaskRepository.create_task(user.id, self.test_task_name, self.test_task_text, self.test_task_state, self.test_folder_id)
    ...
    def test_update_task(self):
        ...
        user_task = OrmTaskRepository.update_task(user.id, task.id, new_test_task_name, new_test_task_text, new_test_task_state, self.test_folder_id)
